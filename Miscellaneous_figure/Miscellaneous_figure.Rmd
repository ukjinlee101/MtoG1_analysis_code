...
bed1 <- import(here(chipDir, "RAD21_ESC-DMSO_unionPeaks.bed"), format="BED")
bed2 <- import(here(chipDir, "RAD21_ESC-dTAG_unionPeaks.bed"), format="BED")
...
```{r}
chipDir <- here("../reference", "ChIP", "RAD21-HA")
bed1 <- import(here(chipDir, "UnionPeaks_RAD21-HA_ESC-DMSO.bed"), format="BED")
bed2 <- import(here(chipDir, "UnionPeaks_RAD21-HA_EpiLC.bed"), format="BED")

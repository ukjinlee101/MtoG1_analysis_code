...
```{r}
qcutoff <- 0.0001
loop <- fread(here(loopDir, paste0("fithic_union_10000bp_qcutoff", qcutoff, ".bedpe")))
...
consensus.loop.anno.tb <- fread(here(loopDir, paste0("fithic_union_10000bp_qcutoff", qcutoff, ".bedpe")))

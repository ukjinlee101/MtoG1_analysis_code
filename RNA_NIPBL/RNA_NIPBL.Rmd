...
# ggplot(dataToPlot, aes(x = timepoint, y = abs(fc))) +
#   geom_violin(color = "black",
#               linewidth = lineMedium * mmToLineUnit, lineend = "square",
#               show.legend = FALSE) + geom_boxplot(width =0.4) +
#   facet_grid(group_Epi ~ group_RAD21)

p <- ggplot(dataToPlot %>% dplyr::filter(group_RAD21 == "RAD21_sensitive"), aes(x = group_Epi, y = abs(fc), fill = group_Epi)) +

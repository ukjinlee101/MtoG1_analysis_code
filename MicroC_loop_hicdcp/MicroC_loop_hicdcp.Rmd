...
fwrite(loop.merged, here(loopDir, paste0("hicdcp_union_", res*1000, "bp.bedpe")), 
...
### Annotate anchors
```{r}
consensus.loop.tb <- fread(here(loopDir, "hicdcp_union_10000bp.bedpe"))

colnames(consensus.loop.tb) <- c("chrom1", "start1", "end1", "chrom2", "start2", "end2")
...
consensus.loop.anno.tb <- fread(here(loopDir, "hicdcp_union_10000bp.bedpe"))

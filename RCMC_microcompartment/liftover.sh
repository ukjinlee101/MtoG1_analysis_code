...
awk 'BEGIN{OFS="\t"}{print $0,NR}' MicrocompartmentLoops_PlusMin1kb_mm39.bedpe > withID.bedpe
...
liftOver -bedPlus=1 a1.bed /Volumes/UKJIN_SSD/reference/liftOver/mm39ToMm10.over.chain.gz a1.mm10.bed a1.unmapped.bed
liftOver -bedPlus=1 a2.bed /Volumes/UKJIN_SSD/reference/liftOver/mm39ToMm10.over.chain.gz a2.mm10.bed a2.unmapped.bed
